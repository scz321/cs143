...
// //
// // A few special class names are 
// //installed in the lookup table but not
...
// //因为scope的list使用了头插法，所以这里最先插入symboltable的属于是最外层的
//   addid(No_class,
...
//进行函数调用的测试--其实按理说没必要，因为你最终还是必须要找到问题所在，
//现在主要就是为了，看看最终效果，预期效果这还是很重要的
#include <string>
#include <vector>
#include <algorithm>
#include <map>
...
void CgenClassTable::code() {
    ...
    //到此为止，所有需要的汇编代码应该都生成完毕了hhh
    //呃呃，没错，就是应该更倾向于在后面的吧，
    //呃呃，多进行假说演绎法行不行，感觉这是一个提高情商的有效办法
